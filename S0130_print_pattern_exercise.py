...
Tip: brug end="" som anden parameter i print() for at undgå at få udskrevet hver string i en ny linje. Mere om det: https://www.geeksforgeeks.org/gfact-50-pyth on-end-parameter-in-print/ .
